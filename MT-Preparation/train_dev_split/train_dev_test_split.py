...
def split_dataset(source_file, target_file):
    ...
    segment_no_train = 0.8 * len(df)
    segment_no_dev = 0.1 * len(df)
    segment_no_test = 0.1 * len(df)
    ...
    source_file_train = source_file+'_train'
    target_file_train = target_file+'_train'

    source_file_dev = source_file+'_dev'
    target_file_dev = target_file+'_dev'

    source_file_test = source_file+'_test'
    target_file_test = target_file+'_test'
...
if __name__ == "__main__":
  ...
  split_dataset(source_file, target_file)
